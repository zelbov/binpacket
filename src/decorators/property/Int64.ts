...
(to, source, offset, propName) => to.writeBigInt64LE(BigInt(''+source[propName]), offset) - offset

export const writeInt64BEHandler : BinaryWriteHandler<Object> = 
(to, source, offset, propName) => to.writeBigInt64BE(BigInt(''+source[propName]), offset) - offset

export const writeUInt64LEHandler : BinaryWriteHandler<Object> = 
(to, source, offset, propName) => to.writeBigUint64LE(BigInt(''+source[propName]), offset) - offset

export const writeUInt64BEHandler : BinaryWriteHandler<Object> = 
(to, source, offset, propName) => to.writeBigUint64BE(BigInt(''+source[propName]), offset) - offset
