...
(to, source, offset, propName) => [to.writeInt16LE(+source[propName!] || 0, offset) - offset, to]

export const writeInt16BEHandler : BinaryWriteHandler<Object> = 
(to, source, offset, propName) => [to.writeInt16BE(+source[propName!] || 0, offset) - offset, to]

export const writeUInt16LEHandler : BinaryWriteHandler<Object> = 
(to, source, offset, propName) => [to.writeUint16LE(+source[propName!] || 0, offset) - offset, to]
